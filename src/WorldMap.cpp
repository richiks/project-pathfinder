/**
 * @brief This file contains implementations of the members of the WorldMap class.
 * See WorldMap.h for declarations and documentation of each member.
 * @headerfile WorldMap.h
...
const std::string WorldMap::LABEL_FONT_STRING = WorldMap::LABEL_FONT_NAME + "-"
        + integerToString(WorldMap::LABEL_FONT_SIZE);
