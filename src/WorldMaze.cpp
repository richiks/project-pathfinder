/**
 * @brief This file contains implementations of the members of the WorldMaze class.
 * See WorldMaze.h for declarations and documentation of each member.
 * @headerfile WorldMaze.h
