...
!exists($$PWD/lib/CPPLib/private/version.h) {
    message("")
    message(*******************************************************************)
    message(*** ERROR: C++library not found!)
...
!exists($$PWD/lib/spl.jar) {
    message("")
    message(*******************************************************************)
    message(*** ERROR: Java back-end library 'spl.jar' not found!)
...
win32 {
    !exists($$PWD/lib/addr2line.exe) {
        message("")
        message(*******************************************************************)
        message(*** ERROR: C++library support file 'addr2line.exe' not found!)
...
exists($$PWD/lib/CPPLib/*.cpp) {
    SOURCES *= $$files($$PWD/lib/CPPLib/*.cpp)
}
SOURCES *= $$files($$PWD/lib/CPPLib/collections/*.cpp)
SOURCES *= $$files($$PWD/lib/CPPLib/graphics/*.cpp)
SOURCES *= $$files($$PWD/lib/CPPLib/io/*.cpp)
SOURCES *= $$files($$PWD/lib/CPPLib/private/*.cpp)
SOURCES *= $$files($$PWD/lib/CPPLib/system/*.cpp)
SOURCES *= $$files($$PWD/lib/CPPLib/util/*.cpp)
...
exists($$PWD/lib/CPPLib/*.h) {
    HEADERS *= $$files($$PWD/lib/CPPLib/*.h)
}
HEADERS *= $$files($$PWD/lib/CPPLib/collections/*.h)
HEADERS *= $$files($$PWD/lib/CPPLib/graphics/*.h)
HEADERS *= $$files($$PWD/lib/CPPLib/io/*.h)
HEADERS *= $$files($$PWD/lib/CPPLib/private/*.h)
HEADERS *= $$files($$PWD/lib/CPPLib/system/*.h)
HEADERS *= $$files($$PWD/lib/CPPLib/util/*.h)
...
exists($$PWD/lib/autograder/*.cpp) | exists($$PWD/lib/autograder/$$PROJECT_FILTER/*.cpp) {
    ...
    !exists($$PWD/res/autograder/pass.gif) {
        message("")
        message(*******************************************************************)
        message(*** ERROR: C++ library cannot find image files pass.gif, fail.gif, etc.!)
